...
public class AnimalService {
    ...
    @Path("/read")
    @Produces(MediaType.APPLICATION_JSON)
    public Response serviceReadAnimal() {
        List<Animal> listaAnimal = animalController.controllerReadCompleteAnimalList();
        GenericEntity<List<Animal>> list = new GenericEntity<List<Animal>>(listaAnimal) {
        };
